...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'sales-forecasts', label: 'Sales Forecasts', to: '/sales/forecasts', icon: <ChartMultipleRegular />, permission: 'Opportunities.View', enabled: isItemEnabled('sales-forecasts') },
