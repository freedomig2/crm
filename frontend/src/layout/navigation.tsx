...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'templates', label: 'Templates', to: '/documents/templates', icon: <DocumentSearchRegular />, permission: 'Documents.View', enabled: false },
      { key: 'document-categories', label: 'Document Categories', to: '/documents/categories', icon: <BookDatabaseRegular />, permission: 'Documents.View', enabled: false },
      { key: 'shared-files', label: 'Shared Files', to: '/documents/shared-files', icon: <AppsListRegular />, permission: 'Documents.View', enabled: false },
    ],
  },
  {
    key: 'activities',
    ...
    items: [
      ...
      { key: 'appointments', label: 'Appointments', to: '/activities/appointments', icon: <CalendarAgendaRegular />, permission: 'Activities.View', enabled: false },
      { key: 'phone-calls', label: 'Phone Calls', to: '/activities/phone-calls', icon: <PersonCallRegular />, permission: 'Activities.View', enabled: false },
      { key: 'emails', label: 'Emails', to: '/activities/emails', icon: <DocumentSearchRegular />, permission: 'Activities.View', enabled: false },
      { key: 'meetings', label: 'Meetings', to: '/activities/meetings', icon: <PeopleRegular />, permission: 'Activities.View', enabled: false },
      { key: 'notes', label: 'Notes', to: '/activities/notes', icon: <ClipboardTextLtrRegular />, permission: 'Activities.View', enabled: false },
    ],
  },
  {
    key: 'finance',
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'security-policies', label: 'Security Policies', to: '/security/policies', icon: <ShieldRegular />, permission: 'SecurityPolicies.View', enabled: isItemEnabled('security-policies') },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'workflows', label: 'Workflows', to: '/configuration/workflows', icon: <BranchRequestRegular />, permission: 'Workflows.View', enabled: isItemEnabled('workflows') },
      ...
      { key: 'notification-templates', label: 'Notification Templates', to: '/configuration/notification-templates', icon: <DocumentSearchRegular />, permission: 'NotificationTemplates.View', enabled: isItemEnabled('notification-templates') },
      { key: 'record-statuses', label: 'Record Statuses', to: '/configuration/record-statuses', icon: <SettingsRegular />, permission: 'RecordStatuses.View', enabled: isItemEnabled('record-statuses') },
      { key: 'custom-fields', label: 'Custom Fields', to: '/configuration/custom-fields', icon: <SettingsRegular />, permission: 'CustomFields.View', enabled: isItemEnabled('custom-fields') },
    ],
  },
  {
    key: 'data-management',
  ...
  },
  {
    ...
    items: [
      { key: 'integration-connections', label: 'Connections', to: '/integrations/connections', icon: <AppsListRegular />, permission: 'Integrations.View', enabled: isItemEnabled('integration-connections') },
      { key: 'integration-sync-runs', label: 'Sync Runs', to: '/integrations/sync-runs', icon: <BranchRequestRegular />, permission: 'IntegrationSyncRuns.View', enabled: isItemEnabled('integration-sync-runs') },
    ],
  },
  {
    key: 'ai-copilot',
    ...
    items: [
      ...
      { key: 'ai-prompt-templates', label: 'Prompt Templates', to: '/ai/prompt-templates', icon: <DocumentSearchRegular />, permission: 'AITemplates.View', enabled: isItemEnabled('ai-prompt-templates') },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'my-notifications', label: 'My Notifications', to: '/personal/notifications', icon: <WarningRegular />, permission: 'Notifications.View', enabled: isItemEnabled('my-notifications') },
