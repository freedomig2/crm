...
export function OrderLinesPage() {
  ...
  const saveLine = async () => {
    ...
    try {
      ...
      resetForm()
      setFormOpen(false)
      setSuccess(editingId ? 'Order line updated successfully.' : 'Order line created successfully.')
      await loadLines()
    } catch {
  ...
  const removeLine = async () => {
    ...
    try {
      ...
      setSuccess('Order line deleted successfully.')
      await loadLines()
    } catch {
  ...
  return (
    <div>
      ...
      <SubgridModalForm
        open={formOpen}
        title={editingId ? 'Edit Order Line' : 'Add Order Line'}
